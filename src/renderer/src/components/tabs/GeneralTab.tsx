      ...
      <CardContent className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">Launch WhatsApp Desktop when you log in</p>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">Start hidden in system tray</p>
          </div>
          <Switch
            id="start-minimized"
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">Minimize to tray instead of quitting</p>
          </div>
          <Switch
            id="close-to-tray"
        ...
        <div className="pt-6 border-t">
          ...
          <p className="text-sm text-muted-foreground">WhatsApp Desktop v1.0.0</p>
